...
- **Expected behavior:** the renamed pair is still flagged above low-noise pairs; unrelated program pairs remain low.
...
- **Expected behavior:** reordered pair remains clearly above unrelated pairs.
- **Representative expectations (`result.txt`):**
...
- **Expected behavior:** submissions that are mostly starter code score low after exclusion.
- **Representative expectations (`result.txt`):**
